...
class CategoriesListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<CategoryModel> categories = [
      CategoryModel(categoryImage: AppAssets.business, categoryName: 'Business'),
      CategoryModel(categoryImage: AppAssets.entertainment, categoryName: 'Entertainment'),
      ...
      CategoryModel(categoryImage: AppAssets.technology, categoryName: 'Technology'),
    ];
    return SizedBox(
      height: 85,
